...
<head>
    ...
    <meta property="og:description" content="Pearlbrill">
    ...
    <!-- Datatable -->
    <link href=" {{ asset('dashboard_assets/css/jquery.dataTables.min.css')}}" rel="stylesheet">
    <link href=" {{ asset('dashboard_assets/css/bootstrap-select.min.css')}}" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/" class="brand-logo">
                <img style="height: 30px;" src="assets/images/updated/logo.png" alt="">
                Pearlbrill
            </a>
            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span class="nav-text">Tutoring</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('tutoring.create')}}">Add</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            <div class="menu-icon">
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            <div class="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="#90959F"  d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                                  </svg>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('dashboard.blogs.index')}}">Table</a></li>
                            <li><a href="{{ route('dashboard.blogs.create')}}">Add</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        <div class="menu-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill="#90959F" d="M16.5 3.75V16.5L12 14.25 7.5 16.5V3.75m9 0H18A2.25 2.25 0 0120.25 6v12A2.25 2.25 0 0118 20.25H6A2.25 2.25 0 013.75 18V6A2.25 2.25 0 016 3.75h1.5m9 0h-9" />
                              </svg>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ route('dashboard.samples.index')}}">Table</a></li>
                        <li><a href="{{ route('dashboard.samples.create')}}">Add</a></li>
                    </ul>
                </li>
                </ul>
            </div>
...
<!-- Main content End --> 
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('dashboard_assets/js/global.min.js')}}"></script>
    <script src="{{ asset('dashboard_assets/js/Chart.bundle.min.js')}}"></script>
    <!-- Apex Chart -->
    <script src="{{ asset('dashboard_assets/js/apexchart.js')}}"></script>

    <!-- Datatable -->
    <script src="{{ asset('dashboard_assets/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{ asset('dashboard_assets/js/datatables.init.js')}}"></script>

    <script src="{{ asset('dashboard_assets/js/bootstrap-select.min.js')}}"></script>
    ...
    <!-- code-highlight -->
    <script src="{{ asset('dashboard_assets/js/highlight.min.js')}}"></script>
    <script>
        hljs.highlightAll();
        hljs.configure({

...
<head>
	...
	<!-- Datatable -->
    <link href="dashboard_assets/css/jquery.dataTables.min.css" rel="stylesheet">
	<link href="dashboard_assets/css/bootstrap-select.min.css" rel="stylesheet">
...
&lt;/div&gt;
    ...
    ***********************************-->
    <!-- Required vendors -->
   <script src="dashboard_assets/js/global.min.js"></script>
    <script src="dashboard_assets/js/Chart.bundle.min.js"></script>
	<!-- Apex Chart -->
	<script src="dashboard_assets/js/apexchart.js"></script>
	
    <!-- Datatable -->
    <script src="dashboard_assets/js/jquery.dataTables.min.js"></script>
    <script src="dashboard_assets/js/datatables.init.js"></script>

	<script src="dashboard_assets/js/bootstrap-select.min.js"></script>
    ...
    <script src="dashboard_assets/js/styleSwitcher.js"></script>
	
	<!-- code-highlight -->
	<script src="dashboard_assets/js/highlight.min.js"></script>
